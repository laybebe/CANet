...
def get_transform(args, is_train=True):
    if is_train:
        transform = transforms.Compose([
            ...
            transforms.Resize((448+64, 448+64)),
...
def make_data_loader(args, is_train=True):
    root_dir = args.data_root_dir#os.path.join(args.data_root_dir, args.data)
    ...
    if args.data == 'COCO2014':
        ...
        train_dataset = data_dict[args.data](root_dir, phase='train', transform=transform)
    else:
        raise NotImplementedError('Value error: No matched dataset!')

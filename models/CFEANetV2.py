...
class CFEANetV2(nn.Module):
    def __init__(self, model,n_classes):
        super(CFEANetV2,self).__init__()
        ...
        self.emau = CAE(512, 200, settings.STAGE_NUM)
        self.gap = nn.AdaptiveAvgPool2d((1, 1))
        self.conv1 = nn.Conv2d(512, 10*20, kernel_size=1)
        self.class_conv = ClassWisePool(10)
        self.WildcatPool2d = WildcatPool2d(kmax=0.2, kmin=None, alpha=0.7)
